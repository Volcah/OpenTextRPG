...
{
	cls();
	cout << "Congratulations, you finished the alpha. Here's a virtual cup f-";
	getch();
	cls();
	cout << "What the...";
	getch();
...
void save()
{
	...
	if (selection == 1) {
		...
		save1o << player.name << endl << player.surname << endl
			<< player.playerclass << endl << player.hp << endl
			<< player.atk << endl << player.mag << endl
			<< player.exp << endl << player.maxHp << endl
			<< player.level << endl << player.nextlevel << endl
			<< player.actualZone << endl;
...
void load()
{
	...
	if (getline(save1i, str))
		player.exp = stoi(str);
	if (getline(save1i, str))
		player.maxHp = stoi(str);
	if (getline(save1i, str))
		player.level = stoi(str);
	if (getline(save1i, str))
		player.nextlevel = stoi(str);
	if (getline(save1i, str))
		player.actualZone = stoi(str);
	save1i.close();
	...
	case 3:
		NULLZone();
	default:
		cout << "Errore nella zona:\n";
		cout << player.actualZone;
		waitkey;
		menu();
		break;
	}
...
void NULLZone()
{
	...
	cout << "\\" << endl;
	//Part 8
	cout << "\\__|  \\__| \\______/ \\________|\\________|" << endl << endl;
	getch();
	cout << "It stares at your soul with its godlike beauty." << endl;
	getch();
	cls();
